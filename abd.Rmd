...
monthly, birds are characterized seaonally, and fish are represented by their 
fall biomass only.  
...
<img src="./avian_all_gif/avian_all.gif", width="49%">
</div>  
...
<div style="text-align: center; padding: 10px">
<img src="./data/abd/monthly_allcet_abd/monthly_allcet.gif", width="49%"> 
<img src="./data/abd/monthly_allcet_abd/annual.png", width="49%">
</div>

Compare maps of monthly cetacean abundance (left, animated) with a map of total
annual abundance averaged across all months (right).  
...
```{r fishoceanog-fig, echo=FALSE, out.width="50%", out.extra='style = "padding:10px; display: inline-block"'}

fishoceanog <-list.files("data/abd/fishoceanog", pattern = ".png", full.names = TRUE)
knitr::include_graphics(fishoceanog)
...
<div style="text-align: center; padding: 10px">
<img src="images/smast_megafauna.png", width="49%">
